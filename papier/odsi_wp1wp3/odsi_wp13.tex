...
\title{Ensuring IoT security with an architecture based on a separation kernel}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Mahieddine Yaker\\and Gilles Grimaud\\ and Julien Cartigny }
\IEEEauthorblockA{CRIStAL - Centre de Recherche\\ en Informatique Signal et Automatique\\ de Lille, F-59000 Lille, France\\
