...
Email: yyy@yyy.com}
\and
\IEEEauthorblockN{Chrystel Gaber \\ and Xiao Han}
...
\label{sec:Intro}
% no \IEEEPARstart
Introduction to be written. \todo[inline]{TBD}
...
Part for Lille \todo[inline]{Lille}
...
\section{Evaluation}
section to show how the isolation model allows to address th industrial needs\todo{TBD}
