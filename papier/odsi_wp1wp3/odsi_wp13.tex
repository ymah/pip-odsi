...
\todo[inline]{TOD0: 
	- Pip fourni l'isolation recherchée par les service pour garantir leur espace de travail/ espace d'adressage
	- Le mechanisme de token garantie que chaque service ne peut être accdédé que via l'API qu'il aura exposée et sans plus}
